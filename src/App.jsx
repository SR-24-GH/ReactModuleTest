          ...
          <Route path='/' element={
            <div className='App' style={{backgroundColor: `${create ? '#2F2F2FBF' : '#FFFFFF'}`}}>
              ...
              <div className='App-main' style={{opacity: `${create ? '50%' : '100%'}`}}>
                ...
                <p className='main-para'>Send and receive messages without keeping your phone online. <br></br>Use Pocket Notes on up to 4 linked devices and 1 mobile phone</p>
